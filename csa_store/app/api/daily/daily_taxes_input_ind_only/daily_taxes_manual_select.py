...
from app.schemas.daily.daily_taxes_input_ind_only.daily_taxes_manual_select_schema import DailyTaxesManualSelectRequest, DailyTaxesManualSelectResponse
