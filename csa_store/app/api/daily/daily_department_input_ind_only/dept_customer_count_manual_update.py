...
from app.schemas.daily.daily_department_input_ind_only.dept_customer_count_manual_update_schema import DeptCustomerCountManualUpdateRequest
from app.utils.daily.form102_helper import get_week_ending_date

logger = logging.getLogger(__name__)

router = APIRouter(
    prefix="/daily/daily_department_input_ind_only/customer_count_manual",
