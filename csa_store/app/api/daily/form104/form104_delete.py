...
from app.schemas.daily.form104.form104_delete_schema import (
    Form104DeleteRequest
)
...
from app.utils.daily.form104_helper import (
    update_dsc_with_form104,
    insert_form104_delete_audit
)
    ...
    try:
        ...
        with DBConnection() as conn:
            ...
            with conn.cursor() as cur:
                ...
                if i_def_department != request.def_department:
