...
from app.schemas.form105a.form105a_update_schema import (
    Form105AUpdateRequest
)
...
from app.utils.form105a_helper import (
    update_dsc_with_form105a,
    insert_form105a_update_audit
)
...
def form105a_update(
    ...
    try:
        ...
        if not request.def_descriptor_1.strip():
        ...
        if not request.def_descriptor_2.strip():
        ...
        if not request.def_descriptor_3.strip():
            ...
            with conn.cursor() as cur:
                ...
                if old_date.date() != request.def_date:
                    ...
                    insert_form105a_update_audit(
                        ...
                        request.def_user,
                        f"Date Changed From: {old_date.strftime('%m/%d/%y')} To: {request.def_date}"
                    )
                ...
                if old_desc4 != request.def_descriptor_4:
                    ...
                    insert_form105a_update_audit(
                        ...
                        request.def_form_type,
                        request.def_user,
                        f"Descriptor 4 Changed From: {old_desc4} To: {request.def_descriptor_4}"
                    )
                ...
                if old_amount2 != request.def_amount_2:
                    ...
                    insert_form105a_update_audit(
                        ...
                        request.def_form_type,
                        request.def_user,
                        f"Amount 2 Changed From: {old_amount2} To: {request.def_amount_2}"
                    )
