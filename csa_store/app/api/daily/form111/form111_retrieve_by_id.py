...
from app.schemas.daily.form111.form111_retrieve_by_id_schema import (
    Form111RetrieveByIdRequest
)
...
def form111_retrieve_by_id(
        request: Form111RetrieveByIdRequest):
    """
    Equivalent of:

    csa_Form111_RetrieveByID
    """
    ...
    try:
            ...
            with conn.cursor() as cur:
                ...
                return {
                    ...
                    "data": {
                        ...
                        "def_amount_1": float(row[8])
                        if row[8] is not None
                        else 0,
                        "def_amount_2": float(row[9])
        ...
        logger.exception(
            "Error in Form111 Retrieve By ID"
        )
